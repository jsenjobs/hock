...
import com.jsen.test.utils.modelcore.common.logical.model.relation.ModeFullJoin;
 ...
 * @since 2018/4/24
 */
public class ModelFullJoinBuild extends AbstractBuild {
    @Override
    public CalcModeBase build(JSONObject jsonObject) {
        ModeFullJoin join = new ModeFullJoin();
